...
client_socket.connect((ipaddress, 1050))
...
client_socket.send('{"device_type":2,"action":"connect","uid":"06249660-262d-4cec-b9f6-f67819465ed9","device_name":"EWControl"}\n')
